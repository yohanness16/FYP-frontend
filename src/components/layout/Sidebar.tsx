...
import { Bus, LayoutDashboard, BarChart3, Truck, Route, Radio, Users, Settings, LogOut, Map, ChevronLeft, ChevronRight } from "lucide-react";

const NAV = [
  { group: "MONITOR", items: [
    { href: "/dashboard",   label: "Dashboard",      icon: <LayoutDashboard size={18}/> },
    { href: "/map",         label: "Live Map",        icon: <Map size={18}/> },
    ...
    <aside className="sidebar-transition fixed left-0 top-0 h-screen z-40 flex flex-col"
      ...
      <div style={{ padding: "24px 16px", display: "flex", alignItems: "center", justifyContent: collapsed ? "center" : "space-between" }}>
        {!collapsed ? (
          ...
          <div style={{ width: 32, height: 32, borderRadius: "50%", background: "var(--neon-dim)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--neon)", cursor: "pointer" }} onClick={toggle}>
        ...
        <div style={{
          ...
          {!collapsed && (
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{
                fontSize: 13, color: isDark ? "#fff" : "#1a2e24",
